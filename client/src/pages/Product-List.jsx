...
const ProductList = (children, func) => {

    let [searchKey, setSearchKey] = useState("0");
    let [perPage, setPerPageKey] = useState(5);
    ...
    const handlePageClick = (event) => {
        GetProductList(event.selected+1,perPage,searchKey)
    };
                            ...
                            <div className="card-body">
                                <div className="container-fluid">
                                    ...
                                    <div className="row">
                                                            ...
                                                            <tr key={i.toString()}>
                                                                <td>
                                                                    <div className="d-flex px-2 py-1">
                                                                        <div>
                                                                            <img src={item.image} alt="image" className="avatar me-3"/>
                                                                        </div>
                                                                ...
                                                                <td>
                                                                    <p className="badge ms-7 bg-gradient-success">{item.stock}</p>
                                                                </td>
                                                                <td>
                                                                    <span className="text-secondary ms-7 text-xs font-weight-bold">{item.product_code}</span>
                                                                </td>
                                                            </tr>
                                                        )
                                                    }
                                        ...
                                        <div className="col-12 overflow-hidden mt-5">
